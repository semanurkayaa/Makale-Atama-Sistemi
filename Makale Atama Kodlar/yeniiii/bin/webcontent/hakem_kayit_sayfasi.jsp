...
<html>
	...
	<body>
		...
		<div class="wrapper" style="background-image: url('colorlib-regform-19/colorlib-regform-19/images/bg-registration-form-3.jpg');">
			<div class="inner">
					<h3>HOCA GİRİŞ</h3>
					<form action="hakem_ekleme_islem.jsp" method="POST">
					<div class="form-group">
						<div class="form-wrapper">
						
							<label>HOCA ADI:</label>
							<div class="form-holder">
								<i class="zmdi zmdi-account-o"></i>
								<input type="text" class="form-control" id="hocakullaniciadi" name="hocakullaniciadi" required="" >
							</div>
						</div>
					...
					<div class="form-group">
						<div class="form-wrapper">
							<label> HOCA ŞİFRE :</label>
							<div class="form-holder">
								<i class="zmdi zmdi-lock-outline"></i> 
								<input type="password" class="form-control" id="hocasifre" name="hocasifre" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required="" >
							</div>
							
							<div class="form-group">
						<div class="form-wrapper">
							<label> HOCA MAİL :</label>
							<div class="form-holder">
								<i class="zmdi zmdi-lock-outline"></i> 
								<input type="text" class="form-control" id="hocamail" name="hocamail"  required="" >
							</div>
							<br><br>
  ...
  <p id="length" class="invalid">Minimum <b>8 characters</b></p>
		...
		<script>
var myInput = document.getElementById("hocasifre");
