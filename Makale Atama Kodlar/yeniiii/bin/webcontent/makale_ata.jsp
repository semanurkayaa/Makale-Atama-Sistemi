...
<html lang="en">
  ...
  <% 
  ResultSet rs=sayiCrud.makaleGetir();
  while(rs.next()) { %>
  <tr>
    ...
    <td><a href='atama_islem.jsp?id=<%=rs.getString("id")%>'>ATAMA İŞLEM<span class="glyphicon glyphicon-edit" style="font-size:24px; color:green;"></span></a></td>
